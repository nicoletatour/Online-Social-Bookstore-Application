...
public class BookDTO {
	...
	private List<UserProfileDTO> requestingUsers;
    ...
    public List<UserProfileDTO> getRequestingUsers() {
        return requestingUsers;
    }

    public void setRequestingUsers(List<UserProfileDTO> requestingUsers) {
